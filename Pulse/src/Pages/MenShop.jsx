...
export default function MenShop() {
  ...
  const menProducts = productsData?.filter(
    (productCategory) => productCategory.category == "Men"
  );
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    return filtered;
  }, [menProducts, category, sortedOption, filteredSearch, collection]);
  ...
  return (
    <div className="generalShop">
      ...
      <p className="generalShopDesc">
        Performance-driven activewear engineered for the dedicated athlete.
